...
class autonext_module_relu(nn.Module):
    def __init__(self, in_channels=4):
        super(autonext_module_relu, self).__init__()
        ...
        self.fa1=illumination_module.FA_Block(64)
        self.fa2=illumination_module.FA_Block(64)
        self.fa3=illumination_module.FA_Block(64)
        self.fa4=illumination_module.FA_Block(64)
...
class autonext_module_sigmoid(nn.Module):
    def __init__(self, in_channels=4, out_ch=1):
        super(autonext_module_sigmoid, self).__init__()
        ...
        self.final_conv=nn.Conv2d(in_channels=in_channels, out_channels=out_ch, kernel_size=3, stride=1, padding=1)
